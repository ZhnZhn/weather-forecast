...
var _LeafletMapFn = require("./LeafletMapFn");
...
const LeafletMap = _ref => {
  ...
  (0, _uiApi.useEffect)(() => {
    const _map = (0, _LeafletMapFn.createMap)(id, () => setMapStatus(MAP_STATUS_LOADED));
    if (_map) {
  ...
  (0, _uiApi.useEffect)(() => {
    if (forecast) {
      (0, _LeafletMapFn.addMarker)(forecast, _refMap.current);
    }
  }, [forecast]);
  return /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
    ...
    children: mapStatus === MAP_STATUS_FAILED && /*#__PURE__*/(0, _jsxRuntime.jsx)(_ErrMsg.default, {
      style: S_ERR_MSG,
      msg: _Tokens.MSH_LEAFLET_MAP_LOADING_FAILED
    })
  });
};
