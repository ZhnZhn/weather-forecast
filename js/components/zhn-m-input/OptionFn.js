...
const getItemCaption = item => (0, _isTypeFn.isArr)(item) ? item[0] : item.caption;
exports.getItemCaption = getItemCaption;
const getItemValue = item => {
  const value = (0, _isTypeFn.isArr)(item) ? (0, _isTypeFn.isStr)(item[1]) ? item[1] : item[0] : item.value;
