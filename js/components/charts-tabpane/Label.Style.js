...
const CAPTION_STYLE = {
  ...
  color: _uiTheme.COLOR.LABEL.color,
  fontWeight: 'bold'
};
...
const S_DAY = exports.S_DAY = _crSpanStyle(_uiTheme.COLOR.DAY.color);
...
const S_CIRCLE_TEMP_MORN = exports.S_CIRCLE_TEMP_MORN = _crCircleStyle(_uiTheme.COLOR.TEMP_DAY.color, 'none');
const S_CIRCLE_TEMP_DAY = exports.S_CIRCLE_TEMP_DAY = _crCircleStyle(_uiTheme.COLOR.TEMP_DAY.color);
const S_TEMP_DAY = exports.S_TEMP_DAY = _crSpanStyle(_uiTheme.COLOR.TEMP_DAY.color);
const S_CIRCLE_TEMP_EVE = exports.S_CIRCLE_TEMP_EVE = _crCircleStyle(_uiTheme.COLOR.TEMP_NIGHT.color, 'none');
const S_CIRCLE_TEMP_NIGHT = exports.S_CIRCLE_TEMP_NIGHT = _crCircleStyle(_uiTheme.COLOR.TEMP_NIGHT.color);
const S_TEMP_NIGHT = exports.S_TEMP_NIGHT = _crSpanStyle(_uiTheme.COLOR.TEMP_NIGHT.color);
