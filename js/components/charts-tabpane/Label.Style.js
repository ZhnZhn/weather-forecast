...
const S_TOOLTIP = exports.S_TOOLTIP = Object.assign({}, _uiTheme.CHART_POPUP, {
  padding: 8
});
const S_TOOLTIP_ROW = exports.S_TOOLTIP_ROW = {
  paddingTop: 8
};
const S_LABEL = exports.S_LABEL = Object.assign({}, CAPTION_STYLE, {
  width: 50
});
const S_CAPTION = exports.S_CAPTION = Object.assign({}, CAPTION_STYLE, {
  paddingRight: 4
});
const S_DAY = exports.S_DAY = _crSpanStyle(_uiTheme.DAY_COLOR);
const S_CIRCLE_SPEED = exports.S_CIRCLE_SPEED = _crCircleStyle(_SeriesColor.SPEED_COLOR, "none");
const S_SPEED = exports.S_SPEED = _crSpanStyle(_SeriesColor.SPEED_COLOR);
const S_CIRCLE_HUMIDITY = exports.S_CIRCLE_HUMIDITY = _crCircleStyle(_SeriesColor.SPEED_COLOR);
const S_HUMIDITY = exports.S_HUMIDITY = _crSpanStyle(_SeriesColor.SPEED_COLOR);

//CIRCLE_RAIN : _crCircleStyle(SC.RAIN),
const S_RECT_RAIN = exports.S_RECT_RAIN = {
  stroke: _SeriesColor.RAIN_COLOR
};
const S_RAIN = exports.S_RAIN = _crSpanStyle(_SeriesColor.RAIN_COLOR);
const S_RECT_SNOW = exports.S_RECT_SNOW = {
  stroke: _SeriesColor.SNOW_COLOR
};
const S_SNOW = exports.S_SNOW = _crSpanStyle(_SeriesColor.SNOW_COLOR);
const S_CIRCLE_TEMP_MAX = exports.S_CIRCLE_TEMP_MAX = _crCircleStyle(_SeriesColor.TEMP_MAX_COLOR, 'none');
const S_TEMP_MAX = exports.S_TEMP_MAX = _crSpanStyle(_SeriesColor.TEMP_MAX_COLOR);
const S_CIRCLE_TEMP_MIN = exports.S_CIRCLE_TEMP_MIN = _crCircleStyle(_SeriesColor.TEMP_MIN_COLOR, 'none');
const S_TEMP_MIN = exports.S_TEMP_MIN = _crSpanStyle(_SeriesColor.TEMP_MIN_COLOR);
...
const S_CIRCLE_PRESSURE = exports.S_CIRCLE_PRESSURE = _crCircleStyle(_SeriesColor.PRESSURE_COLOR);
const S_PRESSURE = exports.S_PRESSURE = _crSpanStyle(_SeriesColor.PRESSURE_COLOR);
const S_SERIA = exports.S_SERIA = _crSpanStyle(_SeriesColor.SERIA_COLOR);
const S_CIRCLE_SERIA = exports.S_CIRCLE_SERIA = _crCircleStyle(_SeriesColor.SERIA_COLOR);
const S_POINTER = exports.S_POINTER = {
  lineHeight: 2,
  cursor: 'pointer'
};
const S_FILTERED = exports.S_FILTERED = {
  color: _SeriesColor.FILTERED_COLOR
};
