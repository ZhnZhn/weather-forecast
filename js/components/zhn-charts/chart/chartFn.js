...
const getDisplayedData = (data, _ref, item) => {
  ...
  return (0, _isTypeFn.isNotEmptyArr)(itemsData) ? itemsData : item && item.props && (0, _isTypeFn.isNotEmptyArr)(item.props.data) ? item.props.data : (0, _isTypeFn.isNotEmptyArr)(data) ? data : [];
};
