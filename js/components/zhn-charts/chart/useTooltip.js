...
const useTooltip = (props, getMouseTooltipData) => {
  const [tooltipState, setTooltipState] = (0, _uiApi.useState)({
  ...
  return [tooltipState, setTooltipState, tooltipItem, events, handleCloseTooltip];
};
