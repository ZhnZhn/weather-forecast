...
describe('precisionFixed', function () {
  var fn = _index.precisionFixed;
  it("precisionFixed(number) returns the expected value", function () {
...
describe('precisionPrefix', function () {
  var fn = _index.precisionPrefix;
  ...
  it("precisionPrefix(step, value) returns zero if step has the same units as value", function () {
  ...
  it("precisionPrefix(step, value) returns greater than zero if fractional digits are needed", function () {
    for (var i = -24; i <= 24; i += 3) {
      for (var j = i - 4; j < i; ++j) {
  ...
  it("precisionPrefix(step, value) returns the expected precision when value is less than one yocto", function () {
  ...
  it("precisionPrefix(step, value) returns the expected precision when value is greater than than one yotta", function () {
...
describe('precisionRound', function () {
  var fn = _index.precisionRound;
  it("precisionRound(step, max) returns the expected value", function () {
